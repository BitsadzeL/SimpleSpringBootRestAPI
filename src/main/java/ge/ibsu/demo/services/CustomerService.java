...
public class CustomerService {
    ...
    public Customer getById(Long id){
        return customerRepository.findById(id).orElseThrow(()->new IllegalArgumentException("User NOT FOUND"));
    ...
    public  Customer addEditCustomer(AddCustomer addCustomer, Long id){
        ...
        Address address=addressService.getByAddress(addCustomer.getAddress());
